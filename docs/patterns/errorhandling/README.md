...
// arrow.core.OptionMonadErrorInstanceImplicits$instance$1@4f835aee
```

```kotlin
monadError<ForTry, Throwable>()
// arrow.core.TryMonadErrorInstanceImplicits$instance$1@340e068d
```

```kotlin
monadError<EitherPartialOf<NukeException>, NukeException>()
// arrow.core.EitherMonadErrorInstanceImplicits$instance$1@3b0b1ee8
```
